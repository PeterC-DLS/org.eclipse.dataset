...
//		classes.put("Boolean", Dataset.BOOL);
	...
	public void testDifference() {
		...
		Dataset a = DatasetFactory.createFromObject(IntegerDataset.class, data, null);
		Dataset d = Maths.difference(a, 1, -1);
		int[] tdata;
		tdata = new int[] {1,  2,  6, -4,  5};
		Dataset ta = DatasetFactory.createFromObject(IntegerDataset.class, tdata, null);
		...
		a = DatasetFactory.createFromObject(CompoundDoubleDataset.class, 2, new double[] {0, 1, 2, 3, 4, 5});
		d = Maths.difference(a, 1, -1);
		ta = DatasetFactory.createFromObject(CompoundDoubleDataset.class, 2, new double[] {2, 2, 2, 2});
		checkDatasets(null, null, d, ta);
		d = Maths.difference(a.getSliceView(slices), 1, -1);
		ta = Maths.difference(a.getSlice(slices), 1, -1);
		checkDatasets(null, null, d, ta);

		a = DatasetFactory.createFromObject(ByteDataset.class, new byte[] {0, 1, 2, 4, 7, 11});
		d = Maths.difference(a, 2, -1);
		ta = DatasetFactory.createFromObject(ByteDataset.class, new byte[] {0, 1, 1, 1});
		checkDatasets(null, null, d, ta);
		d = Maths.difference(a.getSliceView(slices), 2, -1);
		ta = Maths.difference(a.getSlice(slices), 2, -1);
		checkDatasets(null, null, d, ta);

		a = DatasetFactory.createFromObject(CompoundShortDataset.class, 2, new short[] {0, 1, 2, 3, 4, 5, 7, 6});
		d = Maths.difference(a, 2, -1);
		ta = DatasetFactory.createFromObject(CompoundShortDataset.class, 2, new short[] {0, 0, 1, -1});
		checkDatasets(null, null, d, ta);
		d = Maths.difference(a.getSliceView(slices), 2, -1);
		ta = Maths.difference(a.getSlice(slices), 2, -1);
		checkDatasets(null, null, d, ta);

		a = DatasetFactory.createFromObject(CompoundDoubleDataset.class, 2, new double[] {0, 1, 2, 3, 4, 5, 7, 6});
		d = Maths.difference(a, 2, -1);
		ta = DatasetFactory.createFromObject(CompoundDoubleDataset.class, 2, new double[] {0, 0, 1, -1});
		checkDatasets(null, null, d, ta);
		d = Maths.difference(a.getSliceView(slices), 2, -1);
		ta = Maths.difference(a.getSlice(slices), 2, -1);
		checkDatasets(null, null, d, ta);
	...
	public void testGradient() {
		...
		Dataset a = DatasetFactory.createFromObject(DoubleDataset.class, data, null);
		Dataset d = Maths.gradient(a).get(0);
		tdata = new double[] {1., 1.5, 2.5, 3.5, 4.5, 5.};
		Dataset ta = DatasetFactory.createFromObject(DoubleDataset.class, tdata, null);
		checkDatasets(null, null, d, ta);
		Slice[] slices = new Slice[] {new Slice(3)};
		...
		ta = DatasetFactory.createFromObject(DoubleDataset.class, tdata, null);
		...
		a = DatasetFactory.createFromObject(DoubleDataset.class, data, 2, 3);
		List<? extends Dataset> l = Maths.gradient(a);
		tdata = new double[] { 2., 2., -1., 2., 2., -1.};
		ta = DatasetFactory.createFromObject(DoubleDataset.class, tdata, 2, 3);
		...
		ta = DatasetFactory.createFromObject(ByteDataset.class, new byte[] {1, 1, 1, 2, 3, 4});
		checkDatasets(null, null, d, ta);
		...
		a = DatasetFactory.createFromObject(CompoundShortDataset.class, 2, new short[] {0, 1, 2, 3, 4, 5, 7, 6});
		d = Maths.gradient(a).get(0);
		ta = DatasetFactory.createFromObject(CompoundShortDataset.class, 2, new short[] {2, 2, 2, 2, 2, 1, 3, 1});
		checkDatasets(null, null, d, ta);
		d = Maths.gradient(a.getSliceView(slices)).get(0);
		ta = Maths.gradient(a.getSlice(slices)).get(0);
		checkDatasets(null, null, d, ta);
		...
		a = DatasetFactory.createFromObject(CompoundDoubleDataset.class, 2, new double[] {0, 1, 2, 3, 4, 5, 7, 6});
		d = Maths.gradient(a).get(0);
		ta = DatasetFactory.createFromObject(CompoundDoubleDataset.class, 2, new double[] {2, 2, 2, 2, 2.5, 1.5, 3, 1});
		checkDatasets(null, null, d, ta);
		d = Maths.gradient(a.getSliceView(slices)).get(0);
		ta = Maths.gradient(a.getSlice(slices)).get(0);
		checkDatasets(null, null, d, ta);
...
//				System.out.printf("%g %g\n", x, y);
	...
	public void testBitwise() {
		...
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {0, 1, 2, 3, 0, 1, 2, 3}),
				Maths.bitwiseAnd(xa, xb), ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {-4, -3, -2, -1, 4, 5, 6, 7}),
				Maths.bitwiseOr(xa, xb), ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {-4, -4, -4, -4, 4, 4, 4, 4}),
				Maths.bitwiseXor(xa, xb), ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {3, 2, 1, 0, -1, -2, -3, -4}),
				Maths.bitwiseInvert(xa), ABSERRD, ABSERRD);
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {-1, -2, -3, -4, -5, -6, -7, -8}),
				Maths.bitwiseInvert(xb), ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {-4, -6, -8, -8, 0, 32, -128, -128}),
				Maths.leftShift(xa, xb), ABSERRD, ABSERRD);
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {0, 0, 0, 0, 4, 10, 24, 56}),
				Maths.leftShift(xb, xa), ABSERRD, ABSERRD);
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {0, 0, 0, 0, 0, 2, 8, 24}),
				Maths.leftShift(xa, xa), ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {-4, -2, -1, -1, 0, 0, 0, 0}),
				Maths.rightShift(xa, xb), ABSERRD, ABSERRD);
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {0, 0, 0, 0, 4, 2, 1, 0}),
				Maths.rightShift(xb, xa), ABSERRD, ABSERRD);
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {-1, -1, -1, -1, 0, 0, 0, 0}),
				Maths.rightShift(xa, xa), ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {-4, 126, 63, 31, 0, 0, 0, 0}),
				Maths.unsignedRightShift(xa, xb), ABSERRD, ABSERRD);
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {0, 0, 0, 0, 4, 2, 1, 0}),
				Maths.unsignedRightShift(xb, xa), ABSERRD, ABSERRD);
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {0, 0, 0, 0, 0, 0, 0, 0}),
	...
	public void testDivideTowardsFloor() {
		Dataset xa = DatasetFactory.createRange(-4, 4, 1, Dataset.INT8);
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {-2, -2, -1, -1,  0,  0,  1,  1}),
				Maths.divideTowardsFloor(xa, 2), true, ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {2, 1, 1,  0,  0,  -1,  -1, -2}),
				Maths.divideTowardsFloor(xa, -2), true, ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(DoubleDataset.class, new double[] {-1.6, -1.2, -0.8, -0.4, 0, 0.4, 0.8, 1.2}),
				Maths.divideTowardsFloor(xa, 2.5), true, ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(FloatDataset.class, new float[] {1.6f, 1.2f, 0.8f, 0.4f, 0 , -0.4f, -0.8f, -1.2f}),
	...
	public void testFloorDivide() {
		...
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(DoubleDataset.class, new double[] {-2, -2, -1, -1,  0,  0,  0,  1}),
				Maths.floorDivide(xa, 2.5), true, ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(FloatDataset.class, new float[] {1, 1,  0,  0,  0, -1,  -1, -2}),
	...
	public void testFloorRemainder() {
		Dataset xa = DatasetFactory.createRange(-4, 4, 1, Dataset.INT8);
		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {0, 1, 0, 1, 0, 1, 0, 1}),
				Maths.floorRemainder(xa, 2), true, ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(ByteDataset.class, new byte[] {0, -1, 0, -1, 0, -1, 0, -1}),
				Maths.floorRemainder(xa, -2), true, ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(DoubleDataset.class, new double[] {1, 2, 0.5, 1.5, 0, 1, 2, 0.5}),
				Maths.floorRemainder(xa, 2.5), true, ABSERRD, ABSERRD);

		TestUtils.assertDatasetEquals(DatasetFactory.createFromObject(FloatDataset.class, new float[] {-1.5f, -0.5f, -2, -1, 0, -1.5f, -0.5f, -2}),
