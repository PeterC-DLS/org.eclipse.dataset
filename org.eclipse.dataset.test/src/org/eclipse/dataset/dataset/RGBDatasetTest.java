...
public class RGBDatasetTest {
	...
	public void testConverters() {
		...
		RGBDataset rgb = DatasetFactory.createFromObject(RGBDataset.class, rgbs);
		Dataset g = DatasetFactory.createFromObject(ShortDataset.class, new short[] {76,  169,   74,  216,  141,  115});
		TestUtils.assertDatasetEquals(g, rgb.createGreyDataset(Dataset.INT16), 1, 1);

		Dataset h = DatasetFactory.createFromObject(ShortDataset.class, new short[] {0, 60, 120, 180, 240, 300}, 6);
		Dataset v = DatasetFactory.createFromObject(FloatDataset.class, new float[] {1, 0.75f, 0.5f, 1, 1, 0.75f}, 6);
		Dataset s = DatasetFactory.createFromObject(DoubleDataset.class, new double[] {1, 1, 1, 0.5, 0.5, 0.667}, 6);
		...
		Dataset l = DatasetFactory.createFromObject(FloatDataset.class, new float[] {0.5f, 0.375f, 0.25f, 0.75f, 0.75f, 0.5f}, 6);
		s = DatasetFactory.createFromObject(DoubleDataset.class, new double[] {1, 1, 1, 1, 1, 0.5}, 6);
