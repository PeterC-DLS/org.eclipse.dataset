 ...
 */
public class CompoundLongDatasetImpl extends AbstractCompoundDataset<CompoundLongDatasetImpl> implements CompoundLongDataset { // CLASS_TYPE
	...
	protected long[] createArray(final long size) { // PRIM_TYPE
		long[] array = null; // PRIM_TYPE

		try {
			array = new long[(int) (isize * size)]; // PRIM_TYPE
	...
	public static CompoundLongDatasetImpl createFromObject(final Object obj) {
		...
		if (clazz.isArray() && Array.get(obj, 0) instanceof Dataset) {
			return new CompoundLongDatasetImpl((Dataset[]) obj);
		}
	...
	@Override
	public LongDatasetImpl realView() { // CLASS_TYPE
