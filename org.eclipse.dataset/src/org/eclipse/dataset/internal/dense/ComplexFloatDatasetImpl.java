...
// This is generated from ComplexDoubleDatasetImpl.java by fromcpxdouble.py
 ...
 */
public class ComplexFloatDatasetImpl extends CompoundFloatDatasetImpl implements ComplexFloatDataset { // CLASS_TYPE
	...
	public ComplexFloatDatasetImpl() {
		super(ISIZE);
	}
	 ...
	 * @param shape
	 */
	public ComplexFloatDatasetImpl(final int... shape) {
		super(ISIZE, shape);
	}
	 ...
	 */
	public ComplexFloatDatasetImpl(final float[] data, final int... shape) { // PRIM_TYPE
	 ...
	 * @param dataset
	 */
	public ComplexFloatDatasetImpl(final ComplexFloatDatasetImpl dataset) {
		super(dataset);
	}
	 ...
	 * @param shape (can be null to create 1D dataset)
	 */
	public ComplexFloatDatasetImpl(final float[] realData, final float[] imagData, int... shape) { // PRIM_TYPE
	 ...
	 * @param imag
	 */
	public ComplexFloatDatasetImpl(final Dataset real, final Dataset imag) {
	 ...
	 * @param dataset
	 */
	public ComplexFloatDatasetImpl(final Dataset dataset) {
	...
	@Override
	public ComplexFloatDatasetImpl clone() {
		return new ComplexFloatDatasetImpl(this);
	}
	 ...
	 */
	public static ComplexFloatDatasetImpl createFromObject(final Object obj) {
		ComplexFloatDatasetImpl result = new ComplexFloatDatasetImpl();
	 ...
	 */
	public static ComplexFloatDatasetImpl createRange(final double stop) {
	 ...
	 * @return a new 1D dataset, filled with values determined by parameters
	 */
	public static ComplexFloatDatasetImpl createRange(final double start, final double stop, final double step) {
		int size = calcSteps(start, stop, step);
		ComplexFloatDatasetImpl result = new ComplexFloatDatasetImpl(size);
	 ...
	 */
	public static ComplexFloatDatasetImpl ones(final int... shape) {
		return new ComplexFloatDatasetImpl(shape).fill(1);
	}

	@Override
	public ComplexFloatDatasetImpl fill(final Object obj) {
	...
	@Override
	public ComplexFloatDatasetImpl getView() {
		ComplexFloatDatasetImpl view = new ComplexFloatDatasetImpl();
	 ...
	 */
	@Override
	public FloatDatasetImpl imaginary() { // CLASS_TYPE
	 ...
	 */
	@Override
	public FloatDatasetImpl imaginaryView() { // CLASS_TYPE
	...
	@Override
	public ComplexFloatDatasetImpl getSlice(final SliceIterator siter) {
		ComplexFloatDatasetImpl result = new ComplexFloatDatasetImpl(siter.getShape());
	...
	@Override
	ComplexFloatDatasetImpl setSlicedView(Dataset view, Dataset d) {
	...
	@Override
	public ComplexFloatDatasetImpl setSlice(final Object o, final IndexIterator siter) {
	...
	@Override
	public ComplexFloatDatasetImpl iremainder(final Object b) {
