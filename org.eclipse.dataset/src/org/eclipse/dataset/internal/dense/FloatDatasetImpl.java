...
import org.eclipse.dataset.dense.FloatDataset; // CLASS_TYPE
...
public class FloatDatasetImpl extends AbstractDataset<FloatDatasetImpl> implements FloatDataset { // CLASS_TYPE
	...
	protected static float[] createArray(final long size) { // PRIM_TYPE
		float[] array = null; // PRIM_TYPE

		try {
			array = new float[(int) size]; // PRIM_TYPE
	 ...
	 * @param shape
	 */
	public FloatDatasetImpl(final int... shape) {
		if (shape.length == 1) {
			size = shape[0];
			if (size < 0) {
	 ...
	 */
	public FloatDatasetImpl(final float[] data, int... shape) { // PRIM_TYPE
		if (data == null) {
	 ...
	 * @param dataset
	 */
	public FloatDatasetImpl(final FloatDatasetImpl dataset) {
	 ...
	 * @param dataset
	 */
	public FloatDatasetImpl(final Dataset dataset) {
	...
	public boolean equals(Object obj) {
		...
		FloatDatasetImpl other = (FloatDatasetImpl) obj;
	 ...
	 */
	public static FloatDatasetImpl createFromObject(final Object obj) {
		FloatDatasetImpl result = new FloatDatasetImpl();
	 ...
	 */
	public static FloatDatasetImpl createRange(final double stop) {
	 ...
	 * @return a new 1D dataset, filled with values determined by parameters
	 */
	public static FloatDatasetImpl createRange(final double start, final double stop, final double step) {
		int size = calcSteps(start, stop, step);
		FloatDatasetImpl result = new FloatDatasetImpl(size);
	 ...
	 */
	public static FloatDatasetImpl ones(final int... shape) {
	...
	@Override
	public FloatDatasetImpl sort(Integer axis) {
		if (axis == null) {
			Arrays.sort(data);
		} else {
			axis = checkAxis(axis);
			
			FloatDatasetImpl ads = new FloatDatasetImpl(shape[axis]);
	...
	@Override
	public FloatDatasetImpl getUniqueItems() {
		...
		FloatDatasetImpl u = new FloatDatasetImpl(set.size()); // CLASS_TYPE
		int i = 0;
	...
	@Override
	public FloatDatasetImpl getSlice(final SliceIterator siter) {
		FloatDatasetImpl result = new FloatDatasetImpl(siter.getShape());
	...
	public void fillDataset(Dataset result, IndexIterator iter) {
		...
		float[] rdata = ((FloatDatasetImpl) result).data; // PRIM_TYPE
	...
	@Override
	public FloatDatasetImpl setByBoolean(final Object obj, Dataset selection) {
	...
	@Override
	public FloatDatasetImpl setBy1DIndex(final Object obj, final Dataset index) {
		if (obj instanceof Dataset) {
			final Dataset ds = (Dataset) obj;
	...
	@Override
	public FloatDatasetImpl setByIndexes(final Object obj, final Object... indexes) {
	...
	@Override
	FloatDatasetImpl setSlicedView(Dataset view, Dataset d) {
	...
	@Override
	public FloatDatasetImpl setSlice(final Object obj, final IndexIterator siter) {
	...
	@Override
	public FloatDatasetImpl iadd(final Object b) {
	...
	@Override
	public FloatDatasetImpl isubtract(final Object b) {
		Dataset bds = b instanceof Dataset ? (Dataset) b : DatasetFactory.createFromObject(b);
		boolean useLong = bds.getElementClass().equals(Long.class);
		if (bds.getLongSize() == 1) {
			final IndexIterator it = getIterator();
	...
	@Override
	public FloatDatasetImpl imultiply(final Object b) {
		Dataset bds = b instanceof Dataset ? (Dataset) b : DatasetFactory.createFromObject(b);
		boolean useLong = bds.getElementClass().equals(Long.class);
		if (bds.getLongSize() == 1) {
			final IndexIterator it = getIterator();
	...
	@Override
	public FloatDatasetImpl idivide(final Object b) {
		Dataset bds = b instanceof Dataset ? (Dataset) b : DatasetFactory.createFromObject(b);
		boolean useLong = bds.getElementClass().equals(Long.class);
		if (bds.getLongSize() == 1) {
			if (useLong) {
	...
	@Override
	public FloatDatasetImpl ifloor() {
	...
	@Override
	public FloatDatasetImpl iremainder(final Object b) {
		Dataset bds = b instanceof Dataset ? (Dataset) b : DatasetFactory.createFromObject(b);
		boolean useLong = bds.getElementClass().equals(Long.class);
		if (bds.getLongSize() == 1) {
			if (useLong) {
	...
	@Override
	public FloatDatasetImpl ipower(final Object b) {
		Dataset bds = b instanceof Dataset ? (Dataset) b : DatasetFactory.createFromObject(b);
		if (bds.getLongSize() == 1) {
