...
public class Maths {
	...
	private static void difference(final Dataset a, final Dataset out) {
		...
		switch (a.getDType()) {
		case Dataset.INT8:
			final byte[] i8data = ((ByteDataset) a).getData();
			...
			break;
		case Dataset.INT16:
			final short[] i16data = ((ShortDataset) a).getData();
			...
			break;
		case Dataset.INT32:
			final int[] i32data = ((IntegerDataset) a).getData();
			...
			break;
		case Dataset.INT64:
			final long[] i64data = ((LongDataset) a).getData();
			...
			break;
		case Dataset.ARRAYINT8:
			final byte[] ai8data = ((CompoundByteDataset) a).getData();
			...
			break;
		case Dataset.ARRAYINT16:
			final short[] ai16data = ((CompoundShortDataset) a).getData();
			...
			break;
		case Dataset.ARRAYINT32:
			final int[] ai32data = ((CompoundIntegerDataset) a).getData();
			...
			break;
		case Dataset.ARRAYINT64:
			final long[] ai64data = ((CompoundLongDataset) a).getData();
			...
			break;
		case Dataset.FLOAT32:
			final float[] f32data = ((FloatDataset) a).getData();
			...
			break;
		case Dataset.FLOAT64:
			final double[] f64data = ((DoubleDataset) a).getData();
			...
			break;
		case Dataset.COMPLEX64:
			final float[] c64data = ((ComplexFloatDataset) a).getData();
			...
			break;
		case Dataset.COMPLEX128:
			final double[] c128data = ((ComplexDoubleDataset) a).getData();
			...
			break;
		case Dataset.ARRAYFLOAT32:
			final float[] af32data = ((CompoundFloatDataset) a).getData();
			...
			break;
		case Dataset.ARRAYFLOAT64:
			final double[] af64data = ((CompoundDoubleDataset) a).getData();
