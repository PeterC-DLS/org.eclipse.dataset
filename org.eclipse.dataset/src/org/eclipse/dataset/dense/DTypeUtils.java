...
/**
 * Utilities for dataset types and type conversions
 */
public class DTypeUtils {
	...
	static final Map<Class<?>, Integer> dtypeMap = createDTypeMap(); // map of primitive class to dataset type
	...
	private static Map<Class<? extends Dataset>, Integer> createInterfaceMap() {
		Map<Class<? extends Dataset>, Integer> map = new HashMap<>();
