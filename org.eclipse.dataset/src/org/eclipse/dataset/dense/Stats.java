...
public class Stats {
	...
	private static Dataset pQuantile(final Dataset s, final int axis, final double q) {
		...
		oshape[axis] = 1;
		int[] qshape = DatasetUtils.squeezeShape(oshape, false);
	...
	static private void calculateHigherMoments(final Dataset a, final boolean ignoreNaNs, final int axis) {
		...
		final int[] nshape = DatasetUtils.squeezeShape(oshape, false);
		final Dataset sk;
		final Dataset ku;
	...
	public static Dataset typedProduct(final Dataset a, final int dtype, final boolean ignoreNaNs, int axis) {
		...
		result.setShape(DatasetUtils.squeezeShape(oshape, axis));
		return result;
	}
